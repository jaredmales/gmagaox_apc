...
Projecting to  GMagAO-X's contrasts we will extend our search down to low-mass planets like accreting Neptunes at just $\sim1$ AU separations \citep{2019BAAS...51c.527S}. This will allow a complete sample of southern gas protoplanets within $\sim200$ pc. 
...
image down to $\sim$ 0.5 micron wavelengths.
...
\textbf{Risk:} Phasing will not be achieved at our $\sim$30 nm rms requirement. \textbf{Mitigation plan:} We will demonstrate phasing control is possible with the phasing testbed described in \ref{subsection:testbed}. 
...
\textbf{Risk}: Deviations of $\sim100$ microradians due to thermal drifts or vibrations could lead to unstable wavefront/alignment errors of the OAP optics in Fig. \ref{fig:pardm}. \textbf{Mitigation Plan:} Continue to test advanced locking kinematic optical mounts and floating optical tables as part of our phasing testbed efforts (see \ref{subsection:testbed}).
