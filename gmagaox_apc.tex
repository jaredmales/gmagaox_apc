...
\begin{wrapfigure}[12]{r}{3.2in}
\centering
\vspace{-0.4in}
\includegraphics[width=3.1in]{figures/fig2.pdf}
\vspace{-0.2in}
\caption{ Post-coronagraph raw contrast for GMagAO-X using the semi-analytic model of Males and Guyon (2018), for an I=8 mag star such as Prox. Cen.  Throughout this paper we assume instrument performance 10 times worse than this prediction. \label{fig:contrast} }
\end{wrapfigure}
